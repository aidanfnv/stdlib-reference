...
<span class='code'>[<a href=".">PrimalSubstitute</a>(substFn)]</span> attribute denotes a substitute <span class='code'>substFn</span> that should be used for
...
<pre>
[<a href=".">PrimalSubstitute</a>(<a href=".#decl-function" class="code_param">function</a>)]
</pre>
