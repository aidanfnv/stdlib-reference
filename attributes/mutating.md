...
allow <span class='code'>foo</span> to modify <span class='code'>x</span>, you can use <span class='code'>[<a href=".html">mutating</a>]</span> to mark the function as such:
```csharp
struct S
{
   int x;
