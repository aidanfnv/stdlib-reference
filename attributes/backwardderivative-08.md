...
<span class='code'>[<a href=".">BackwardDerivative</a>(bwdFn)]</span> attribute can be used to provide a forward-mode
...
<pre>
[<a href=".">BackwardDerivative</a>(<a href=".#decl-function" class="code_param">function</a>)]
</pre>
