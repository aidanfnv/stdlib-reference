...
Calculates the sum abs(ddx(<span class='code'><a href=".html#decl-p" class="code_param">p</a></span>)) + abs(ddy(<span class='code'><a href=".html#decl-p" class="code_param">p</a></span>)).
...
<a href=".html#typeparam-T" class="code_type">T</a> <a href=".html">fwidth</a>&lt;<a href=".html#typeparam-T" class="code_type">T</a>&gt;(<a href=".html#typeparam-T" class="code_type">T</a> <a href=".html#decl-p" class="code_param">p</a>)
...
## Return value
The sum of abs(ddx(<span class='code'><a href=".html#decl-p" class="code_param">p</a></span>)) and abs(ddy(<span class='code'><a href=".html#decl-p" class="code_param">p</a></span>)).
