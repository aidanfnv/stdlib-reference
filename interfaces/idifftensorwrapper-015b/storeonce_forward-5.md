...
<pre>
<span class="code_keyword">void</span> <a href="../index.md" class="code_type">IDiffTensorWrapper</a>.<a href=".">storeOnce_forward</a>&lt;<a href=".#typeparam-T" class="code_type">T</a>&gt;(
...
<span class="code_keyword">void</span> <a href="../index.md" class="code_type">IDiffTensorWrapper</a>.<a href=".">storeOnce_forward</a>&lt;<a href=".#typeparam-T" class="code_type">T</a>, <a href=".#decl-N" class="code_var">N</a>:<span class="code_keyword">int</span>&gt;(
