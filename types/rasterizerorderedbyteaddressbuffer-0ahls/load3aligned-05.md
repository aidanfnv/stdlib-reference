...
<pre>
<a href="../vector/index.md" class="code_type">vector</a>&lt;<span class="code_keyword">uint</span>, 3&gt; <a href="index.md" class="code_type">RasterizerOrderedByteAddressBuffer</a>.<a href="load3aligned-05.md">Load3Aligned</a>(
    <span class="code_keyword">int</span> <a href="load3aligned-05.md#decl-location" class="code_param">location</a>);
