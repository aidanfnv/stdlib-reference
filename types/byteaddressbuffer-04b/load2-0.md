...
<a href="../vector/index.md" class="code_type">vector</a>&lt;<span class="code_keyword">uint</span>, 2&gt; <a href="index.md" class="code_type">ByteAddressBuffer</a>.<a href="load2-0.md">Load2</a>(<span class="code_keyword">int</span> <a href="load2-0.md#decl-location" class="code_param">location</a>);

/// Requires Capability Set 1:
<a href="../vector/index.md" class="code_type">vector</a>&lt;<span class="code_keyword">uint</span>, 2&gt; <a href="index.md" class="code_type">ByteAddressBuffer</a>.<a href="load2-0.md">Load2</a>(
