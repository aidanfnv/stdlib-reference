...
The shape of the texture. Must be one of <span class='code'><a href="index.html" class="code_type">__Shape1D</a></span>, <span class='code'><a href="index.html" class="code_type">__Shape2D</a></span>, <span class='code'><a href="index.html" class="code_type">__Shape3D</a></span>, <span class='code'><a href="index.html" class="code_type">__ShapeCube</a></span> or <span class='code'><a href="index.html" class="code_type">__ShapeBuffer</a></span>.
...
For other targets, the combined-texture-sampler type is translated to a pair of a <span class='code'>Texture</span> and <span class='code'><a href="index.html" class="code_type">SamplerState</a></span>.
