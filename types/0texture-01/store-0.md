...
####  <a id="decl-location"></a>location  : [vector](../types/vector/index.html)\<uint, isArray + Shape\.dimensions\>
####  <a id="decl-newValue"></a>newValue  : [T](../types/0texture-01/index.html#typeparam-T)
