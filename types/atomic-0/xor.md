...
<pre>
<a href="index.md#typeparam-T" class="code_type">T</a> <a href="index.md" class="code_type">Atomic</a>&lt;<a href="index.md#typeparam-T" class="code_type">T</a>&gt;.<a href="xor.md">xor</a>(
    <a href="index.md#typeparam-T" class="code_type">T</a> <a href="xor.md#decl-value" class="code_param">value</a>,
    <a href="../memoryorder-06/index.md" class="code_type">MemoryOrder</a> <a href="xor.md#decl-order" class="code_param">order</a>)
